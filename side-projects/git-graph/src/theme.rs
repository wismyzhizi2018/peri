...
impl GigTheme {
    ...
    // === 背景 ===
    pub fn graph_bg(&self) -> Color { Color::Rgb(20, 20, 25) }
    pub fn detail_bg(&self) -> Color { Color::Rgb(25, 25, 30) }
    pub fn selected_bg(&self) -> Color { Color::Rgb(40, 40, 60) }
    pub fn toolbar_bg(&self) -> Color { Color::Rgb(35, 35, 45) }
    pub fn sidebar_bg(&self) -> Color { Color::Rgb(22, 22, 28) }
    pub fn panel_bg(&self) -> Color { Color::Rgb(25, 25, 32) }

    // === 状态色 ===
    pub fn status_added(&self) -> Color { Color::Green }
    pub fn status_deleted(&self) -> Color { Color::Red }
    pub fn status_modified(&self) -> Color { Color::Yellow }
