...
Peri 是一个用 Rust 构建的高性能 AI Agent 框架，目标是让开发者能够将 AI 编程助手的完整工作流（ReAct 推理、工具调用、HITL 审批、子 Agent 委派）嵌入自己的应用中，开箱即用、性能可靠。
...
- **SQLite（本地）**：会话线程持久化，路径 `~/.peri/threads/threads.db`
